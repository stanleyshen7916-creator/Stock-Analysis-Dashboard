...
(function installDashboardPresentationGuard() {
  ...
  function installPresentationStyles() {
    ...
    style.textContent = `
      ...
      .score-breakdown{margin-top:14px;padding-top:13px;border-top:1px solid #edf1f5}.score-breakdown.stock-empty{border-top:0;padding-top:0}.score-row{display:grid;grid-template-columns:64px 1fr 40px;align-items:center;gap:9px;font-size:12px;color:#4b5b74;margin:8px 0}.score-row b{color:#1c2c45;font-weight:800;text-align:right}.score-bar-track{height:8px;background:#eaf0f6;border-radius:999px;overflow:hidden}.score-bar-track i{display:block;height:100%;border-radius:999px}.score-bar-track i.fundamental{background:#2563eb}.score-bar-track i.technical{background:#13a878}.score-bar-track i.chip{background:#7351d4}.score-breakdown-note{font-size:11px;color:#8a96a9;margin-top:4px}
      .score-gauge{--pct:0;width:78px;height:78px;border-radius:50%;flex:0 0 auto;display:grid;place-items:center;background:conic-gradient(#13a878 calc(var(--pct)*1%),#eaf0f6 0)}.score-gauge-inner{width:60px;height:60px;border-radius:50%;background:#fff;display:flex;flex-direction:column;align-items:center;justify-content:center}.score-gauge-inner b{font-size:20px;font-weight:900;color:#17283f;line-height:1}.score-gauge-inner span{font-size:9px;color:#8a96a9}
      .ind-warn{color:#f59e0b!important;font-weight:800}.ind-danger{color:#ef4444!important;font-weight:800}.ind-good{color:#13a878!important;font-weight:800}
      ...
      <div class="stock-analysis-page">
        ...
        <div class="stock-analysis-top">
          ...
          <aside class="stock-signal">
            <div class="stock-signal-head"><div id="analysis-score-gauge" class="score-gauge" style="--pct:0"><div class="score-gauge-inner"><b id="analysis-ai-score">—</b><span>/ 100</span></div></div><div><div id="analysis-decision" class="signal-title">資料不足</div><div id="analysis-decision-sub" class="signal-sub">AI 推薦狀態</div></div></div>
            ...
            <div id="analysis-score-breakdown" class="score-breakdown stock-empty">尚無真實模型分數細項。</div>
          </aside>
        </div>
        ...
        <div class="stock-grid-main">
          ...
          <section class="stock-panel"><h3>關鍵指標 <span class="more">更多 ›</span></h3><div class="stock-panel-sub">依真實 Production 日線資料，於瀏覽器端計算的技術指標（非 Production 評分邏輯）。</div><div id="analysis-technical"><table class="stock-table"><tbody><tr><th>技術面綜合分數</th><td id="analysis-technical-score">資料不足</td></tr><tr><th>MA20</th><td id="analysis-ind-ma20">資料不足</td></tr><tr><th>EMA20</th><td id="analysis-ind-ema20">資料不足</td></tr><tr><th>RSI14</th><td id="analysis-ind-rsi14">資料不足</td></tr><tr><th>MACD</th><td id="analysis-ind-macd">資料不足</td></tr><tr><th>KD (K/D)</th><td id="analysis-ind-kd">資料不足</td></tr><tr><th>Bollinger 上軌</th><td id="analysis-ind-boll">資料不足</td></tr><tr><th>ATR14</th><td id="analysis-ind-atr14">資料不足</td></tr></tbody></table></div></section>
        </div>
        <div class="stock-grid-main">
