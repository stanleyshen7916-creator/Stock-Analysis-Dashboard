  ...
  function install() {
    ...
    if (!document.getElementById('analysis-tabs-integration-fix')) {
      ...
      style.textContent = `
        ...
        #analysis-tab-content .more{float:right;font-size:12px;color:#2563eb;font-weight:700}
        ...
        #analysis-tab-content .analysis-axis{display:flex;justify-content:space-between;font-size:12px;color:#718099;margin-top:4px}
        #analysis-tab-content .volume-bars{height:90px;display:flex;align-items:flex-end;gap:3px;border-bottom:1px solid #dfe6ef;padding:0 3px}
        #analysis-tab-content .volume-bars i{display:block;flex:1;min-width:2px;background:#5b9bd5;border-radius:2px 2px 0 0}
